...
os.system("mJPEG -red "+ "SDSS_frame-"+"i"+"-00"+str(run)+"-"+str(camcol)+"-0"+str(field)+ "cropped.fits "+ " 30% max gaussian-log \
        -green  SDSS_frame-"+"r"+"-00"+str(run)+"-"+str(camcol)+"-0"+str(field)+"cropped.fits "+" 30% max gaussian-log \
        -blue SDSS_frame-"+"g"+"-00"+str(run)+"-"+str(camcol)+"-0"+str(field)+"cropped.fits "+ " 30% max gaussian-log \
        -out "+str(floor(ra))+"_"+str(floor(dec))+"_30%min.jpg")
