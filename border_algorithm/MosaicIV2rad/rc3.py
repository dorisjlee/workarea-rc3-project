...
ra= 14.1779166667              
dec=-9.91416666667 
radius =  0.0527046277749/2. #radius = diameter/2
# margin = 1.2*radius
margin = 2*radius
...
os.system("stiff "+" SDSS_i_"+str(trunc(ra))+"_"+str(trunc(dec))+ ".fits "+ " SDSS_r_"+str(trunc(ra))+"_"+str(trunc(dec))+ ".fits "+" SDSS_g_"+str(trunc(ra))+"_"+str(trunc(dec))+ ".fits "+ "  -c stiff.conf  " +"  -OUTFILE_NAME  MARGIN_1.2rad_deg_"+str(trunc(ra))+"_"+str(trunc(dec))+"_COLORSAT_3_MAX_MAN_10.tiff   -COLOUR_SAT  3  -MAX_TYPE MANUAL -MAX_LEVEL 10")
# for b in bands:
# 	os.system("rm -r "+b+"/")
