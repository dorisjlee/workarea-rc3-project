...
for line in file("rc3_ra_dec_radius_csv(Final).txt"):
    ...
    os.system("stiff "+" SDSS_i_"+str(trunc(ra))+"_"+str(trunc(dec))+ ".fits "+ " SDSS_r_"+str(trunc(ra))+"_"+str(trunc(dec))+ ".fits "+" SDSS_g_"+str(trunc(ra))+"_"+str(trunc(dec))+ ".fits "+ "  -c stiff.conf  " +"  -OUTFILE_NAME  MARGIN_3rad_"+str(trunc(ra))+"_"+str(trunc(dec))+"_COLORSAT_2_MAX_MAN_5.tiff   -COLOUR_SAT  2 -MAX_TYPE MANUAL -MAX_LEVEL 5")
    for b in bands:
        os.system("rm -r "+b+"/")
