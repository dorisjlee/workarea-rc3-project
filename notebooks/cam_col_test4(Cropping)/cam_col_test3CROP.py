...
# os.system("mJPEG -blue   SDSS_frame-i-001239-3-0128cropped.fits -1s 99.999% gaussian-log \
#         -green  SDSS_frame-g-001239-3-0128cropped.fits -1s 99.999% gaussian-log \
#         -red SDSS_frame-r-001239-3-0128cropped.fits -1s 99.999% gaussian-log \
