...
for ele in bands:
	band =ele
	out = "frame-"+str(band)+"-00"+str(run)+"-"+str(camcol)+"-00"+str(field)
	...
	if (CUTOFF) :
		out2 = "frame-"+str(band)+"-00"+str(run)+"-"+str(camcol)+"-00"+str(field-1)
	...
	montage.mSubimage("SDSS_"+out+".fits","SDSS_"+out+"cropped.fits",
		ra,dec,0.05033333333400003)
...
os.system("mJPEG -blue "+ "SDSS_frame-"+"i"+"-00"+str(run)+"-"+str(camcol)+"-00"+str(field)+ "cropped.fits "+ " -1s 99.999% gaussian-log \
        -green SDSS_frame-"+"g"+"-00"+str(run)+"-"+str(camcol)+"-00"+str(field)+"cropped.fits "+" -1s 99.999% gaussian-log \
        -red SDSS_frame-"+"r"+"-00"+str(run)+"-"+str(camcol)+"-00"+str(field)+"cropped.fits "+" -1s 99.999% gaussian-log \
        -out camcoltest4.jpg")
